...
config_file = "./configs/config_unest.yaml"
...
model = load_state_dict(model, "/share/project/zhaohuxing/nvidia_generation/proj_maisi/logs/unest_ep200_noaug/autoencoder.pt")
model.eval()
...
inference(val_files_brats21, "predictions_brats21/unest")
