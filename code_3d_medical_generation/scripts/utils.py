...
def erode_one_img(mask_t: Tensor, filter_size = 3, pad_value: float = 1.0) -> Tensor:
    """
...
def dilate_one_img(mask_t: Tensor, filter_size=3, pad_value: float = 0.0) -> Tensor:
    """
...
def dynamic_infer(inferer, model, images, **kwargs):
    """
    ...
    # else:
        ...
        # else :
        #     return inferer(network=model, inputs=images, rdm_rep=rdm_rep)

    return inferer(network=model, inputs=images, **kwargs)
