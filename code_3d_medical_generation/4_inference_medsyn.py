...
config_file = "./configs/config_medsyn.yaml"
...
model = load_state_dict(model, "/share/project/zhaohuxing/nvidia_generation/proj_maisi/logs/medsyn_ep200/autoencoder.pt")
model.eval()
...
inference(val_files_brats21, "predictions_brats21/medsyn")
