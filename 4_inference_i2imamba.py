...
config_file = "./configs/config_hinet.yaml"
...
model = ResCNN3D(input_dim=2, output_dim=2).to(device)
...
model = load_state_dict(model, "/share/project/zhaohuxing/nvidia_generation/proj_maisi/logs/i2imamba_ep200/autoencoder.pt")
model.eval()
...
inference(val_files_brats21, "predictions_brats21/i2imamba")
