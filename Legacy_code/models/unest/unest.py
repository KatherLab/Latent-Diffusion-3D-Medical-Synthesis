...
from .unest_blocks import UnestBasicBlock, UnestPrUpBlock, UnestUpBlock, UnestAttUpBlock,  UnetOutBlock
from monai.networks.blocks import Upsample
from monai.networks.blocks.dynunet_block import get_conv_layer, get_padding


from .unest_blocks import ViT
import torch
...
class UNEST(nn.Module):
    ...
    def __init__(
        ...
        self.out = nn.Sequential(
            nn.ReflectionPad3d(p),
            nn.Conv3d(feature_size, out_channels, kernel_size=out_kernel, padding=0),
            # nn.Tanh()
        )
